      ...
      <section className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-3xl text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-xl mx-auto">
            Connect your Strava and Garmin accounts to automatically sync activities. Every workout
            you record on Strava will appear in Garmin Connect.
          </p>
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Create your account using your Google account for secure, password-free login.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Link your Strava account using secure OAuth authentication.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  New Strava activities are automatically converted to FIT format and uploaded to
                  Garmin Connect.
                </p>
              </div>
            </div>
